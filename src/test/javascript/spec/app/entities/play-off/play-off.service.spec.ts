...
describe('Service Tests', () => {
    ...
    describe('PlayOff Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(PlayOffService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/play-offs/' + 123);
            });
            it('should return PlayOff', () => {

                let entity: PlayOff;
                service.find(123).subscribe((_entity: PlayOff) => {
                    entity = _entity;
                });
